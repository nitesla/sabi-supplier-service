...
//        ShipmentItem shipmentItem = new ShipmentItem();
     ...
     * @return
     */
    public Page<Shipment> findAllMasterShipment(Long warehouseId, Long logisticPartnerId, String logisticsPartnerName, String phoneNumber, String vehicle, String status, PageRequest pageRequest ){
        ShipmentShipmentResponseDto responseDto = new ShipmentShipmentResponseDto();
        Page<Shipment> shipments = shipmentRepository.findShipments(warehouseId,logisticPartnerId,logisticsPartnerName,phoneNumber,vehicle,status,pageRequest);
        if(shipments == null){
            throw new NotFoundException(CustomResponseCode.NOT_FOUND_EXCEPTION, " No record found !");
...
//                shipment.getShipmentItemResponseDtoList().add(shipmentItem);
                ...
                shipment.setShipmentItemResponseDtoList(shipmentItemList);
                log.info("Checking ::::::::::: {} 123 " + shipmentItemList);
            });
            shipment.setShipmentItemResponseDtoList(shipmentItemList);
            List<ProductCount> savedProductCount = productCountRepository.findProductCountByShipmentId(shipment.getId());
            ...
            shipment.setProductCountResponseList(productCountResponseList);
