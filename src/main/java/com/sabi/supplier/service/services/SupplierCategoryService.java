...
import com.sabi.suppliers.core.models.response.SupplierCategoryResponseDto;
...
//}
    ...
    public Page<SupplierCategory> findAll(String name, Integer creditPeriod, Boolean isActive, PageRequest pageRequest) {
        Page<SupplierCategory> supplierCategory = supplierCategoryRepository.findSupplierCategory(name, creditPeriod, isActive, pageRequest);
        if (supplierCategory == null) {
            throw new NotFoundException(CustomResponseCode.NOT_FOUND_EXCEPTION, " No record found !");
        }
        return supplierCategory;
