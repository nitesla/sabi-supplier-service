...
//    }
     ...
     */
    public Page<Stock> findAll(Long supplyGoodId,String action,Long userId, PageRequest pageRequest ){
        Page<Stock> stocks = stockRepository.findStocks(supplyGoodId,action,userId,pageRequest);
        if(stocks == null){
